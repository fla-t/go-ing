...
const (
	...
	BookingService_UpdateRide_FullMethodName    = "/booking.BookingService/UpdateRide"
)
...
func (c *bookingServiceClient) UpdateRide(ctx context.Context, in *UpdateRideRequest, opts ...grpc.CallOption) (*UpdateRideResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedBookingServiceServer) UpdateRide(context.Context, *UpdateRideRequest) (*UpdateRideResponse, error) {
...
func _BookingService_UpdateRide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).UpdateRide(ctx, req.(*UpdateRideRequest))
	}
	return interceptor(ctx, in, info, handler)
}
